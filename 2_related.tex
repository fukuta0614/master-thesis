...
\begin{figure}[tbp]
     ...
     \end{center}
    \caption{\label{fig:data_augmentation}Data Augmentationの例．Random Crop，Random Rotation，Random Flip，Random Color Augmentationを行った．\todo{それぞれが何を表すのか}}
\end{figure}
...
中でも，Pool-based Samplingの問題設定での研究が最も行われており，本研究でも病理画像のラベルなしサンプルプールは予め与えられているものとする．
